import {
  ...
  type BackendProviderDef,
} from '@/shared/backend-llm-providers'
...
// 前端用 PROVIDER_REGISTRY，后端 LLM 提供商改为复用 `shared/backend-llm-providers.ts`。

export type { BackendProviderDef }
export { BACKEND_LLM_PROVIDERS }
