...
import type { TextAttrs } from '@/lib/openmaic/prosemirror/utils';
import { defaultRichTextAttrs } from '@/lib/openmaic/prosemirror/utils';
import type { TextFormatPainter, ShapeFormatPainter, CreatingElement } from '@/lib/openmaic/types/edit';
