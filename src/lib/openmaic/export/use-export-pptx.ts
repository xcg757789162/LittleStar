...
import { useMediaGenerationStore, isMediaPlaceholder } from '@/lib/openmaic/store/media-generation';
...
import type {
  ...
  PPTElementShadow,
  PPTElementLink,
} from '@/lib/openmaic/types/slides';
import type { Scene, SlideContent } from '@/lib/openmaic/types/stage';
import type { SpeechAction } from '@/lib/openmaic/types/action';
import { getElementRange, getLineElementPath, getTableSubThemeColor } from '@/lib/openmaic/utils/element';
import { type AST, toAST } from '@/lib/openmaic/export/html-parser';
import { type SvgPoints, toPoints, getSvgPathRange } from '@/lib/openmaic/export/svg-path-parser';
import { svg2Base64 } from '@/lib/openmaic/export/svg2base64';
import { latexToOmml } from '@/lib/openmaic/export/latex-to-omml';
