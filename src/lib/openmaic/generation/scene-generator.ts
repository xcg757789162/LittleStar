...
import { MAX_VISION_IMAGES } from '@/lib/openmaic/constants/generation';
import type {
  SceneOutline,
...
import type { StageStore } from '@/lib/openmaic/api/stage-api';
import { createStageAPI } from '@/lib/openmaic/api/stage-api';
import { generatePBLContent } from '@/lib/openmaic/pbl/generate-pbl';
...
import type { PPTElement, Slide, SlideBackground, SlideTheme } from '@/lib/openmaic/types/slides';
import type { QuizQuestion } from '@/lib/openmaic/types/stage';
import type { Action } from '@/lib/openmaic/types/action';
import type {
  AgentInfo,
