...
import { useWhiteboardHistoryStore } from '@/lib/openmaic/store/whiteboard-history';
import { useMediaGenerationStore, isMediaPlaceholder } from '@/lib/openmaic/store/media-generation';
import { getClientTranslation } from '@/lib/openmaic/i18n';
import type { AudioPlayer } from '@/lib/openmaic/utils/audio-player';
import type {
  Action,
  SpotlightAction,
  LaserAction,
  ...
  WbDeleteAction,
  WbDrawLineAction,
} from '@/lib/openmaic/types/action';
