...
import type { SlideTheme, SlideBackground } from '@/lib/openmaic/types/slides';
...
export function createCanvasAPI(store: StageStore) {
  return {
    ...
    setSpotlightPercentage(
      sceneId: string,
      elementId: string,
      geometry: import('@/lib/openmaic/types/action').PercentageGeometry,
      options: SpotlightOptions = {},
    ): APIResult<boolean> {
      try {
        const canvasStore = useCanvasStore.getState();
    ...
    setLaser(
      ...
      elementId: string,
      geometry: import('@/lib/openmaic/types/action').PercentageGeometry,
      options: import('@/lib/openmaic/store/canvas').LaserOptions = {},
    ): APIResult<boolean> {
      try {
        const canvasStore = useCanvasStore.getState();
