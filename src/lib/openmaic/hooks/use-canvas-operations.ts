...
import { useSceneData, useSceneSelector } from '@/lib/openmaic/contexts/scene-context';
import {
  useCanvasStore,
  type SpotlightOptions,
  type HighlightOverlayOptions,
} from '@/lib/openmaic/store/canvas';
import type { SlideContent } from '@/lib/openmaic/types/stage';
import type { PPTElement, Slide } from '@/lib/openmaic/types/slides';
import { useCallback, useMemo } from 'react';
import { useHistorySnapshot } from '@/lib/openmaic/hooks/use-history-snapshot';
import { toast } from 'sonner';
import { ElementAlignCommands, ElementOrderCommands } from '@/lib/openmaic/types/edit';
import { getElementListRange } from '@/lib/openmaic/utils/element';
