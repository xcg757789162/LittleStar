...
import { db } from '@/lib/openmaic/utils/database';
import type { SceneOutline, PdfImage, ImageMapping } from '@/lib/openmaic/types/generation';
import type { AgentInfo } from '@/lib/openmaic/generation/generation-pipeline';
import type { Scene } from '@/lib/openmaic/types/stage';
import type { Action, SpeechAction } from '@/lib/openmaic/types/action';
import type { TTSProviderId } from '@/lib/openmaic/audio/types';
import { splitLongSpeechActions } from '@/lib/openmaic/audio/tts-utils';
