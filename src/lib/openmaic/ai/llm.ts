...
import type { ProviderType, ThinkingCapability, ThinkingConfig } from '@/lib/openmaic/types/provider';
const log = createLogger('LLM');

// Re-export for external use
export type { ThinkingConfig } from '@/lib/openmaic/types/provider';
