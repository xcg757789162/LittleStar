...
export const TTS_PROVIDERS: Record<TTSProviderId, TTSProviderConfig> = {
  ...
  'minimax-tts': {
    ...
    // Curated MiniMax voice list for the classroom settings voice picker.
    // Voice IDs match MiniMax's official system voice list (platform.minimax.io/docs/faq/system-voice-id).
    voices: [
      // ── English ──
      {
      ...
      },
      {
        ...
        language: 'zh-CN',
        gender: 'female',
        description: '温婉柔和，娓娓道来，亲切且富有感染力',
      },
      {
...
export const DEFAULT_TTS_VOICES: Record<TTSProviderId, string> = {
  ...
  'minimax-tts': 'Chinese (Mandarin)_Sweet_Lady',
