...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/openmaic/ui/card';
import { Badge } from '@/components/openmaic/ui/badge';
import { ScrollArea } from '@/components/openmaic/ui/scroll-area';
import { Avatar, AvatarImage, AvatarFallback } from '@/components/openmaic/ui/avatar';
