...
import { CanvasToolbar } from '@/components/openmaic/canvas/canvas-toolbar';
import { useAudioRecorder } from '@/lib/openmaic/hooks/use-audio-recorder';
import { useI18n } from '@/lib/openmaic/hooks/use-i18n';
import { toast } from 'sonner';
import { useSettingsStore, PLAYBACK_SPEEDS } from '@/lib/openmaic/store/settings';
import { ProactiveCard } from '@/components/openmaic/chat/proactive-card';
import { PresentationSpeechOverlay } from '@/components/openmaic/roundtable/presentation-speech-overlay';
import { AvatarDisplay } from '@/components/openmaic/ui/avatar-display';
import { HoverCard, HoverCardTrigger, HoverCardContent } from '@/components/openmaic/ui/hover-card';
import { useAgentRegistry } from '@/lib/openmaic/orchestration/registry/store';
import { DEFAULT_TEACHER_AVATAR, DEFAULT_USER_AVATAR } from '@/components/openmaic/roundtable/constants';
import type { DiscussionAction } from '@/lib/openmaic/types/action';
import type { EngineMode, PlaybackView } from '@/lib/openmaic/playback';
import type { Participant } from '@/lib/openmaic/types/roundtable';
