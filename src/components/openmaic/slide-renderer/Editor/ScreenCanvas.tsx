...
import { useSlideBackgroundStyle } from '@/lib/openmaic/hooks/use-slide-background-style';
import { useCanvasStore } from '@/lib/openmaic/store';
import { useSceneSelector } from '@/lib/openmaic/contexts/scene-context';
import { findElementGeometry } from '@/lib/openmaic/utils/geometry';
import type { SlideContent } from '@/lib/openmaic/types/stage';
import type { PPTElement, SlideBackground } from '@/lib/openmaic/types/slides';
import type { PercentageGeometry } from '@/lib/openmaic/types/action';
