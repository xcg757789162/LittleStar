...
import { useCanvasStore, useSceneSelector } from '@/lib/openmaic/store';
import type { CreateCustomShapeData } from '@/lib/openmaic/types/edit';
import type { SlideContent } from '@/lib/openmaic/types/stage';
import type { SlideTheme } from '@/lib/openmaic/types/slides';
