...
import { useCanvasStore, useKeyboardStore } from '@/lib/openmaic/store';
import { useHistorySnapshot } from '@/lib/openmaic/hooks/use-history-snapshot';
import type { PPTElement } from '@/lib/openmaic/types/slides';
import type { AlignmentLineProps } from '@/lib/openmaic/types/edit';
import { getRectRotatedRange, uniqAlignLines, type AlignLine } from '@/lib/openmaic/utils/element';
import { useCanvasOperations } from '@/lib/openmaic/hooks/use-canvas-operations';
