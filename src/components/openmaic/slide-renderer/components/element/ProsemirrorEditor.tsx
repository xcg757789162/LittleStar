...
import { useKeyboardStore, useCanvasStore } from '@/lib/openmaic/store';
import type { EditorView } from 'prosemirror-view';
import { toggleMark, wrapIn, lift } from 'prosemirror-commands';
import { initProsemirrorEditor, createDocument } from '@/lib/openmaic/prosemirror';
import {
  ...
  markActive,
  getFontsize,
} from '@/lib/openmaic/prosemirror/utils';
import emitter, {
  EmitterEvents,
  type RichTextAction,
  type RichTextCommand,
} from '@/lib/openmaic/utils/emitter';
import { alignmentCommand } from '@/lib/openmaic/prosemirror/commands/setTextAlign';
import { indentCommand, textIndentCommand } from '@/lib/openmaic/prosemirror/commands/setTextIndent';
import { toggleList } from '@/lib/openmaic/prosemirror/commands/toggleList';
import { setListStyle } from '@/lib/openmaic/prosemirror/commands/setListStyle';
import { replaceText } from '@/lib/openmaic/prosemirror/commands/replaceText';
import type { TextFormatPainterKeys } from '@/lib/openmaic/types/edit';
