...
import { useStageStore } from '@/lib/openmaic/store';
...
import { Roundtable } from '@/components/openmaic/roundtable';
import { PlaybackEngine, computePlaybackView } from '@/lib/openmaic/playback';
import type { EngineMode, TriggerEvent, Effect } from '@/lib/openmaic/playback';
import { ActionEngine } from '@/lib/openmaic/action/engine';
import { createAudioPlayer } from '@/lib/openmaic/utils/audio-player';
import { useDiscussionTTS } from '@/lib/openmaic/hooks/use-discussion-tts';
import type { AudioIndicatorState } from '@/components/openmaic/roundtable/audio-indicator';
import type { Action, DiscussionAction, SpeechAction } from '@/lib/openmaic/types/action';
import { cn } from '@/lib/openmaic/utils';
// Playback state persistence removed — refresh always starts from the beginning
import { ChatArea, type ChatAreaRef } from '@/components/openmaic/chat/chat-area';
import { agentsToParticipants, useAgentRegistry } from '@/lib/openmaic/orchestration/registry/store';
...
export function Stage({
  ...
  // Responsive: auto-collapse sidebar & chat on small screens (tablet/mobile)
  useEffect(() => {
