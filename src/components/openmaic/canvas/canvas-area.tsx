...
import { SceneRenderer } from '@/components/openmaic/stage/scene-renderer';
import { SceneProvider } from '@/lib/openmaic/contexts/scene-context';
import { Whiteboard } from '@/components/openmaic/whiteboard';
import { CanvasToolbar } from '@/components/openmaic/canvas/canvas-toolbar';
import type { CanvasToolbarProps } from '@/components/openmaic/canvas/canvas-toolbar';
