...
import type { SessionType } from '@/lib/openmaic/types/chat';
import type { LectureNoteEntry } from '@/lib/openmaic/types/chat';
import type { DiscussionRequest } from '@/components/openmaic/roundtable';
import type { Action, SpeechAction, DiscussionAction } from '@/lib/openmaic/types/action';
...
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@/components/openmaic/ui/tabs';
