...
import type { ProvidersConfig } from '@/types/openmaic/settings';
...
import { validateProvider, validateModel } from '@/stores/openmaic/settings-validation';
...
const getDefaultAudioConfig = () => ({
  ...
  asrProvidersConfig: {
    ...
    'minimax-asr': { apiKey: '', baseUrl: '', enabled: false },
